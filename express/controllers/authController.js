...
const resendOtp = async (req, res) => {
	...
	try {
		...
		otpEntry.resetTokenExpiry = new Date(Date.now() + 3600000);
		await otpEntry.save();
...
module.exports = { loginUser, validateOtp, resendOtp, updatePassword, updateProfile, me, forgotPassword, resetPassword, resendForgotPasswordOtp, logout, validatePassword }
