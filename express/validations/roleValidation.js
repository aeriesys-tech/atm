...
const toggleSoftDeleteRoleValidation = (req, res, next) => {
    return Validate([
...
// const getPaginatedRolesValidation = (req, res, next) => {
//     return Validate([
...
module.exports = {
    ...
    toggleSoftDeleteRoleValidation,
    // getPaginatedRolesValidation
};