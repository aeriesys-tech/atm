...
const createParameterType = (req, res, next) => {
    return Validate([
...
const updateParameterType = (req, res, next) => {
    return Validate([
...
const getParameterType = (req, res, next) => {
    return Validate([
        param("id", "Invalid role ID format").isMongoId(),
    ])(req, res, next);
};

const deleteParameterType = (req, res, next) => {
    return Validate([
...
const paginatedParameterTypes = (req, res, next) => {
    return Validate([
