...
const { createParameterType, updateParameterType, getParameterType, paginatedParameterTypes, deleteParameterType } = require('../validations/');
...
router.post('/paginateParameterTypes', authMiddleware, parameterTypeController.paginatedParameterTypes);
