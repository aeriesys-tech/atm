...
router.post('/updateDataSourceConfiguration', authMiddleware, update_data_source_validation, dataSourceConfigurationController.updateDataSourceConfiguration);
