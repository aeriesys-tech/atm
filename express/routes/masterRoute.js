...
router.post('/updateMaster', authMiddleware, updateMasterValidation, masterController.updateMaster);

// router.post('/masters/:masterId/add', authMiddleware, dynamicTableValidation, checkPermission("masters.create"), masterController.insertDynamicData);
...
router.post('/paginateMasters', authMiddleware, masterController.getPaginatedMasters);
...
router.post('/getMasters', authMiddleware, masterController.getAllMasters);
