...
const steps = [
  { name: "Tag Configuration", path: "/recurring-tagconfiguration" },
  { name: "DB Connection", path: "/recurring-dbconnection" },
  { name: "DQ Configuration", path: "/recurring-dqconfiguration" },
  { name: "Preview Job", path: "/recurring-previewjobs" },
];

const RecurringMenubar = () => {
...
export default RecurringMenubar;
