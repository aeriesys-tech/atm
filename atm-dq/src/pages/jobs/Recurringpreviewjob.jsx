...
function Recurringpreviewjob({ maxHeight = "calc(100vh - 530px)" }) {
  const header = (
    <div className="flex items-center justify-between md:px-10 px-4 py-2">
      <Headertext Text="Jobs - Recurring" />
      <Link to="/jobs/recurringjob">
      ...
      <Layout header={header}>
        <div className="flex flex-col md:flex-row w-full gap-4">
          ...
          <div className="w-full md:w-[60%]">
            <div className="flex flex-col md:flex-row items-start  justify-between gap-4 md:gap-6 p-4 bg-white rounded-lg shadow border border-gray-200">
              {/* Plant Info */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
          ...
          <div>
            <span className="font-medium text-gray-900">Job Frequency:</span>
            <span className="ml-1">Hourly</span>
          </div>
          <div>
            <span className="font-medium text-gray-900">Data Length:</span>
            <span className="ml-1">100 min</span>
          </div>
        </div>
...
export default Recurringpreviewjob;
