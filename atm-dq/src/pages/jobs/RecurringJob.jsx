										...
										sortedData.map((item, idx) => (
											...
											>
												...
												<td className="px-4 py-2 text-center">
													<span
														className={`inline-block px-3 py-1 text-sm font-semibold rounded-md ${getStatusClass(
															item.status
														)}`}
													>
														{item.status}
												...
												<td className="px-4 py-2 text-center">
													<label className="inline-flex relative items-center cursor-pointer">
														...
														/>
														<div
															className={`w-11 h-6 rounded-full transition-colors duration-300 ${item.status === "Running"
																? "bg-green-500"
																: "bg-red-500"
																}`}
														></div>
														<div
															className={`absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${item.status === "Running" ? "translate-x-5" : ""
																}`}
														></div>
													</label>
												</td>
