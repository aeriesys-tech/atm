...
const intervals = ["1 Min", "30 Sec", "45 Sec"];
const statuses = ["success"];
const jobtype = ["One-Time", "Schedule", "Recurring"];
const plants = ["DHCW", "ACW", "RCW", "DLCW", "BKCW", "RDCW"];
const dataTypes = ["ATM", "Usecase", "Direct"];
...
const sampleData = Array.from({ length: 5 }, () => {
  ...
  return {
    ...
    plants: plants[Math.floor(Math.random() * plants.length)], // New plants field
    dataType: dataTypes[Math.floor(Math.random() * dataTypes.length)], // New dataType field
  };
});
...
function Histroy() {
  ...
  const filteredData = sampleData.filter(
    (item) =>
      ...
      item.plants.toLowerCase().includes(search.toLowerCase()) || // Include plants in search
      item.dataType.toLowerCase().includes(search.toLowerCase()) // Include dataType in search
  );
      ...
      <Layout header={header}>
        <div className="flex flex-col h-full min-h-[calc(100vh-215px)] space-y-4">
          ...
          <div className="flex-1 overflow-hidden rounded-md">
            ...
            >
              <table className="min-w-[1400px] overflow-x-auto w-full text-left border-collapse table-fixed">
                <thead className="bg-gray-100 text-gray-600 sticky top-0 z-10">
                  <tr>
                    ...
                    <th
                      className="px-4 py-2 cursor-pointer w-28"
                    ...
                    <th
                      className="px-4 py-2 cursor-pointer w-34"
                    ...
                    <th className="px-4 py-2 cursor-pointer w-25">Status</th>
                  ...
                  {paginatedData.length > 0 ? (
                    paginatedData.map((item, idx) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2">{item.jobType}</td>

                        <td className="px-4 py-2">{item.plants}</td>
                        ...
                        <td className="px-4 py-2 text-center">
                          <div className="flex items-center justify-center gap-2">
                            <Link to="/tagconfiguration">
                              <button className="text-green-500 hover:text-green-700">
                                <TbCopy className="w-4 h-4" />
                              </button>
                            </Link>
                            <Link
                              to="/jobs/onetimepreviewjob"
                    ...
                    <tr>
                      <td
                        colSpan="12" // Updated colSpan to account for new columns
