      ...
      <Layout header={header}>
        <div className="flex flex-col h-full min-h-[calc(100vh-215px)] space-y-4">
          ...
          <div className="flex-1 overflow-hidden rounded-md">
            ...
            >
              <table className="min-w-[1200px] overflow-x-auto w-full text-left border-collapse table-fixed">
                <thead className="bg-gray-100 text-gray-600 sticky top-0 z-10">
                  <tr>
                    ...
                    <th
                      className="px-4 py-2 cursor-pointer w-[9%]"
                    ...
                    <th
                      className="px-4 py-2 cursor-pointer w-[12%]"
                    ...
                    <th
                      className="px-4 py-2 cursor-pointer w-[10%]"
