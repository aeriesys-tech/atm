...
const AssetsCustomNode = ({ data, id, onDoubleClick, templateName }) => {
  ...
  // Use templateName for the root node, otherwise use data.label
  const displayLabel = id === "asset-class-node" ? templateName || data.label : data.label;

  return (
    <div
      ref={nodeRef}
      className={`resizable-node ${id === "asset-class-node" ? "asset-class-node" : ""}`}
