...
function Modal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Fixed Header */}
        <div className="addunit-header d-flex justify-content-between align-items-center border-bottom">
          <h4>{title}</h4>
        ...
        <form
          ...
          style={{
            flex: 1,
            overflowY: "auto", // 🔹 scroll only body
            padding: "8px",
          }}
        >
          <div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: displayOnly
                ? "1fr"
                : fields.length > 3
                ? "1fr 1fr"
                : "1fr",
